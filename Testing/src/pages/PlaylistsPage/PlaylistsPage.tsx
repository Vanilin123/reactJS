	...
	return (
		<div className="usersPage">
			...
			<div className="users">
				<label>
					введите альбом{" "}
					<input data-testid="inputAlbom" type="text" value={searchName} onChange={handleSearchName} />
				</label>
				<label>
					введите жанр{" "}
					<input data-testid="inputGenre" type="text" value={searchGenre} onChange={handleSearchGenre} />
				</label>
